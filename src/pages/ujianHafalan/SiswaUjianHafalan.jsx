      ...
      const fetchData = async () => {
         try {
            ...
            const [responseDetailHalaqah, responseDataGuru] = await Promise.all(
               [getDetailHalaqah(id), getAllGuru()]
            );
            setLoading(false);
                     ...
                     <Tr key={idx}>
                        ...
                        <Td>
                           <Menu>
                              ...
                              <MenuList>
                                 <MenuItem
                                    onClick={() => opeModalUpdate(item.id)}
                                 >
                                    Edit
                                 </MenuItem>
                                 <MenuItem
                                    onClick={() => onOpenAlertConfirm(item.id)}
                                 >
                                    Delete
                                 </MenuItem>
                              </MenuList>
                        ...
                        <InputCustom
                           ...
                           leftAddon={
                              <InputLeftAddon
                                 ...
                                 onClick={() => {
                                    const value =
                                       parseInt(getValues("kesalahan_tajwid")) -
                                       1;
                                    if (value >= 0) {
