                  ...
                  >
                     {
                        dataKehadiran.find(
                           (e) =>
                              e.user.id === item.siswa_id && e.meet === "Meet 1"
                        )?.status
                     }
                  </Td>
                  <Td
                  ...
                  >
                     {
                        dataKehadiran.find(
                           (e) =>
                              e.user.id === item.siswa_id && e.meet === "Meet 2"
                        )?.status
                     }
                  </Td>
                  <Td
                  ...
                  >
                     {
                        dataKehadiran.find(
                           (e) =>
                              e.user.id === item.siswa_id && e.meet === "Meet 3"
                        )?.status
                     }
                  </Td>
                  <Td
                  ...
                  >
                     {
                        dataKehadiran.find(
                           (e) =>
                              e.user.id === item.siswa_id && e.meet === "Meet 4"
                        )?.status
                     }
                  </Td>
                  <Td
                  ...
                  >
                     {
                        dataKehadiran.find(
                           (e) =>
                              e.user.id === item.siswa_id && e.meet === "Meet 5"
                        )?.status
                     }
                  </Td>
                  ...
                  <Td>
                     {
                        dataKehadiran.filter(
                           (e) =>
                              e.user.id === item.siswa_id && e.status === "Izin"
                        ).length
                     }
                  </Td>
                  <Td>
