      ...
      {!singleLinkTo ? (
            ...
            <Flex gap={1} flexDirection="column" marginBottom={1}>
              {listNav?.map((item, idx) => (
                <Box
                  ...
                  color={
                    location.pathname.includes(item.to) ? "#fff" : "#343A40"
                  }
        ...
        <>
          <Flex
            ...
            color={
              location.pathname.includes(singleLinkTo) ? "#F8F9FA" : "#343A40"
            }
            cursor="pointer"
            padding={2}
            alignItems="center"
            ...
            opacity={location.pathname.includes(singleLinkTo) ? "1" : "0.5"}
          >
            <Image
              src={location.pathname.includes(singleLinkTo) ? IconSingle : icon}
              w="16px"
              h="16px"
              alt="master data"
            />
