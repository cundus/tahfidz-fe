  ...
  useEffect(()=> {
    const getSiswa = async() => {
      try {
        ...
        const aktifLength  = response.users.filter(item=> item.profile.status === true).length
        const nonAktifLength  = response.users.filter(item=> item.profile.status === false).length
